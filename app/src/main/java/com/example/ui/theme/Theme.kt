...
private val LightColorScheme = lightColorScheme(
    ...
    onPrimary = LightCreamBackground,
    secondary = PurpleGrey40,
    background = LightCreamBackground,
    surface = LightCreamSurface,
    onBackground = CoolGreyText,
    onSurface = CoolGreyText,
    surfaceVariant = LightCreamBorder,
    onSurfaceVariant = CoolGreyTextMuted
)
